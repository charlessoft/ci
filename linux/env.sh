...
PATH=$PATH:$JAVA_HOME/bin:$M2_HOME/bin:$SVN_HOME/bin:$JMETER_HOME/bin
...
echo export PATH=$PATH:$JAVA_HOME/bin:$M2_HOME/bin:$SVN_HOME/bin:$JMETER_HOME/bin >> /etc/profile
